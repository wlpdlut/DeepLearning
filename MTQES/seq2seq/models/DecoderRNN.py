...
class DecoderRNN(BaseRNN):
    ...
    def forward(self, inputs=None, encoder_hidden=None, encoder_outputs=None,
        ...
        if use_teacher_forcing:
            ...
            decoder_output, decoder_hidden, attn, hhat = self.forward_step(decoder_input,
                                                                           decoder_hidden,
            ...
            for di in range(max_length):
                decoder_output, decoder_hidden, step_attn, hhat = self.forward_step(decoder_input, decoder_hidden,
                                                                                    encoder_outputs, function=function)
        ...
        return decoder_outputs, decoder_hidden, ret_dict, hhats
